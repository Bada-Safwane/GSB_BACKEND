...
const {   getBills,getBillById,updateBillById,deleteBillById,createBill,bulkUpdateStatus,ocrExtract} = require('../controllers/bills_controller');
...
router.post('/ocr', verifyToken, upload.single('image'), ocrExtract);
